    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to=user.models.user_directory_path, verbose_name='picture')),
                ('banner_picture', models.ImageField(blank=True, null=True, upload_to=user.models.user_banner_directory_path, verbose_name='banner_picture')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user', to='auth.permission', verbose_name='user permissions')),
                ('things_i_love', models.ManyToManyField(blank=True, related_name='user', to='user.thingsilove', verbose_name='Things User likes')),
            ],
            options={
                'verbose_name': 'user',
